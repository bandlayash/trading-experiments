...
>
> Other strategies: [Donchian + Aroon](../../tree/strategy/donchian-aroon) &middot; [SMA + Momentum](../../tree/strategy/sma-momentum) &middot; [EMA9 / RSI14](../../tree/strategy/ema-rsi-meanrev) &middot; [HMM regime](../../tree/strategy/hmm-regime) &middot; [MAG7 overnight](../../tree/strategy/mag7-overnight) &middot; [Sentiment (design)](../../tree/strategy/sentiment)
...
> slightly — this strategy's Sharpe held at **0.49** while its max drawdown moved −16.1% → −16.4%. The analysis below (the parameter sweep, the
