...
>
> Other strategies: [SMA + Momentum](../../tree/strategy/sma-momentum) &middot; [Seykota](../../tree/strategy/seykota) &middot; [EMA9 / RSI14](../../tree/strategy/ema-rsi-meanrev) &middot; [HMM regime](../../tree/strategy/hmm-regime) &middot; [MAG7 overnight](../../tree/strategy/mag7-overnight) &middot; [Sentiment (design)](../../tree/strategy/sentiment)
...
> slightly — this strategy's Sharpe moved **0.90 → 0.88**, its OOS Sharpe 0.97 → 0.94, and its growth multiple 262× → 224×. The analysis below (the parameter sweep, the
